    ...
    <div className='container-fluid d-flex align-items-center p-3 custom-header'>
      ...
      {showMenu && (
        <div className='menu-floating'>
          <div className='row'>
            <div className='col'>
              <Link to={"/acceuil"} className="fw-bold btn btn-outline-secondary text-light LienMenu">
                Acceuil
              </Link>
            </div>
          </div>
          <div className='row '>
            <div className='col'>
              <Link to={"/consult_commande"} className='fw-bold btn btn-outline-secondary text-light LienMenu'>
                Commandes
              </Link>
            </div>
          </div>
          <div className='row '>
            <div className='col'>
              <Link to={"/historique_reclamations"} className="fw-bold btn btn-outline-secondary text-light LienMenu">
                Réclamations
              </Link>
            </div>
          </div>
          <div className='row '>
            <div className='col'>
              <Link to={'/mise_a_jour'} className='fw-bold btn btn-outline-secondary text-light LienMenu'>
                Mise à jour Menu
              </Link>
            </div>
          </div>

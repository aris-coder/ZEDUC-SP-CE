...
import { Link, NavLink } from 'react-router-dom'; // Import des composants Link et NavLink

function NavbarReclamation() {
  return (
        ...
        <div className="collapse navbar-collapse" id='navbarNav'>
          <ul className="navbar-nav" style={{ width: '100%', justifyContent: 'space-between', fontFamily: 'Times New Roman' }}>
            <li className="nav-item">
              <NavLink className="nav-link"  to="/reclamtion" style={({ isActive }) => ({ color: isActive ? 'white' : '#ffffff' })}>
                GestionReclamations
              </NavLink> 
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" style={{ color: '#ffffff' }} to="/employee">
...
export default NavbarReclamation;

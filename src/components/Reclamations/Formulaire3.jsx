...
const PopoverForm = ({ onAdd, selectedReclamation }) => {
  ...
  useEffect(() => {
    if (selectedReclamation) {
      setNom(selectedReclamation.nom);
      setCommande(selectedReclamation.Commande);
      setDate(selectedReclamation.Date);
      setStatut(selectedReclamation.Statut);
  ...
  const handleSubmit = (e) => {
    ...
    const Reclamation = {
      ...
      Date,
      Statut,
      id: selectedReclamation ? selectedReclamation.id : Date.now() // Utilise l'ID existant si modification
    };
    ...
    <>
      ...
      <Modal show={showModal} onHide={handleCancel} centered>
        <Modal.Header closeButton>
          <Modal.Title>{selectedReclamation ? 'Modifier une Reclamation' : 'Ajouter une Reclamation'}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            ...
            <div className="d-flex justify-content-between">
              ...
              <div>
                ...
                <Button variant="success" type="submit">
                  {selectedReclamation ? 'Modifier' : 'Ajouter'}
                </Button>
              </div>
            </div>
          </Form>
